...
def process_stream(stream):
    ...
    def send_to_kafka(rdd):
        ...
        for r in results:
            ...
            try:
                logger.info('Sending average temperature %s to kafka' % data)
    ...
    def pair(data):
        ...
        return record.get('zipcode'), (float(record.get('temp')), 1)
...
# spark-submit --jars spark-streaming-kafka-0-8-assembly_2.11-2.0.0.jar stream_processing.py weather_analyzer average-temperature localhost:9092